...
export function DashboardShell() {
  ...
  return <div className={`erp-shell ${sidebarCompact ? "compact" : ""}`}>
    ...
    <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
      <div className="sidebar-brand"><div className="sidebar-logo"><Image src="/dopamina-mark.png" alt="Dopamina" width={54} height={54} unoptimized /></div><button className="close-sidebar-mobile" onClick={() => setSidebarOpen(false)} aria-label="Fechar menu"><X size={20} /></button></div>
