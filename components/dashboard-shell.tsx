...
function StockPage(props: Parameters<typeof SectionContent>[0]) {
  ...
  return <section className="stock-page"><ModuleHero eyebrow="Operação e controle" title="Estoque virtual e inventário" description="Acompanhe o saldo teórico, conte o estoque físico e preserve cada diferença no histórico." action="Nova contagem" icon={<Boxes size={20} />} onAction={() => setInventoryOpen(true)} />
